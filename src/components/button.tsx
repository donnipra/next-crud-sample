...
export const EditButton = ({id}:{id:string}) => {
  ...
  export const SubmitButton = ({label}:{label:string}) => {
    ...
    const className = clsx("text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-sm text-sm w-full px-5 py-3 text-center",{"opacity-50 cursor-propgress":pending})
